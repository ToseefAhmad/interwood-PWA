...
export const PLACE_ORDER = gql`
    mutation placeOrder($cartId: String!,$bank_name:String,$tenure:String) {
        placeOrder(input: { cart_id: $cartId, bank_name:$bank_name, tenure:$tenure }) @connection(key: "placeOrder") {
            order {
                order_number
            }
        }
