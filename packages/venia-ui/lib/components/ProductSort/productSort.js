...
const ProductSort = props => {
    ...
    return (
        <div ref={elementRef} className={classes.root}>
            <a
                priority={'low'}
                className={[defaultClasses["sort-btn"]," "].join(' ')}
            ...
            >
                <FormattedMessage
                    ...
                    defaultMessage={'Sort'}
                />
                <img src={require("../../assets/img/angle-down.svg")} className={[defaultClasses["filter-icons"],""].join(' ')} alt=""/>
            </a>
            {sortElements}
        </div>
    );
