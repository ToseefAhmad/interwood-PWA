...
export const useCreateAccount = props => {
    ...
    const {data : citiesData } = useQuery(getCities, { variables : {countryName : 'Pakistan'}});
    ...
    const handleSubmit = useCallback(
        async formValues => {
            ...
            try {
                ...
                let region=null;
                if(formValues.region && formValues.region.region_id)
                {
              region=formValues.region.region_id
                }
                ...
                await createAccount({
                    variables: {
                        ...
                        country_id:formValues.address.country_code,
                        country_code:formValues.address.country_code,
                        postcode:formValues.postcode,
                        telephone:formValues.address.telephone,
                        region_id:region
                    }
                });
