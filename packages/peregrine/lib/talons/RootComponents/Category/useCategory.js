...
export const useCategory = props => {
    ...
    const metaKeywords =
    data && data.category && data.category.meta_keywords
        ? data.category.meta_keywords
    : '';

    const metaTitle =
    data && data.category && data.category.meta_title
    ...
    const metaMenuImage =
    data && data.category && data.category.menu_image
        ? data.category.menu_image
    : '';
