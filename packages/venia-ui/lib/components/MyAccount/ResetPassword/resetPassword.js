...
const ResetPassword = props => {
    ...
    const recoverPassword = hasCompleted ? (
        ...
        <Form className={classes.container} onSubmit={handleSubmit}>
            ...
            <h2 className={[defaultClasses["form-head"],  " "].join(' ')}>Reset your account password</h2>
            <strong className={[defaultClasses["text-head"],  " "].join(' ')}>Please enter your email address and new password.</strong>
