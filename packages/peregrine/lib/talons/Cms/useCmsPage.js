...
export const useCmsPage = props => {
    ...
    const metaDescription = cmsPage ? cmsPage.meta_description : '';
    const metaTitle = cmsPage ? cmsPage.meta_title : " Interwood | Pakistan's Leading Home & Office Furniture Store ";
    const metaKeywords = cmsPage ? cmsPage.meta_keywords : '';
