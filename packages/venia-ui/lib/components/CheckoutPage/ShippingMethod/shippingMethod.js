...
const ShippingMethod = props => {
    const { onSave, pageIsUpdating, setPageIsUpdating, items, total } = props;
    ...
    if (displayState === displayStates.DONE) {
        ...
        if (displayState === displayStates.EDITING) {
            ...
            bodyContents = (
                ...
                >
                    ...
                    <div className={[defaultClasses["shipping-method-content"],  "shipping-area"].join(' ')}>
                        <ShippingRadios
        ...
        contents = (
            <div className={classes.root}>
                <h3 className={[defaultClasses["checkout-form-title"],  " "].join(' ')}>
                    <FormattedMessage
